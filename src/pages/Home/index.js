...
import { StatusBar, Text, ScrollView, View, RefreshControl, Button  } from 'react-native';
...
export class Home extends Component {
  ...
  render(){
    ...
    if(this.props.totalSolicitacao != 0)
    {
        ...
        totalConcluidasGrafico = (this.props.totalAndamento / this.props.totalSolicitacao) * 100;
        totalAndamentoGrafico = (this.props.totalAndamento / this.props.totalSolicitacao) * 100;
        totalPendentesGrafico = ( (this.props.totalSolicitacao - this.props.totalConcluidos) / this.props.totalSolicitacao) * 100;
    }
    ...
    return (
        ...
        <ViewTop>
            <ContainerTop>
                <ButtonIcon onPress={() => this.props.navigation.navigate('Login')}><Icon name ="ios-arrow-back" size={35} color="#FFF" /></ButtonIcon>
            ...
            <Carrousel color={'red'} onChangeMonth={(obj) => this._onChangeMonth(obj)} />
        </ViewTop>
        ...
        >
          ...
          <Container>
              ...
              <ViewBG>
                  ...
                  <CardMain>
                      ...
                      <AnimatedCircularProgress
                        ...
                        backgroundColor="#9B9B9B">
                        {
                            () => (
                                <View style={{alignItems: 'center'}}>
                                <Text style={{fontSize: 28, fontWeight: 'bold', color: '#242972', allowFontScaling: false}}>
                                  {total} %
                                </Text>
                                <Text style={{fontSize: 20, color: '#959595', textAlign: 'center'}}>
                                Concluidas
                                </Text>
                                </View>
                            )
                      ...
                      style={{backgroundColor: (this.state.selectIndex == 0 ? "#9B9B9B" : "#FBFBFB")}}>
                          <TextNumber style={{color: (this.state.selectIndex == 0 ? "#FFF" : "#000")}}>{this.props.totalSolicitacao}</TextNumber>

                          <TextCardB style={{color: (this.state.selectIndex == 0 ? "#FFF" : "#000")}}>Solicitações totais</TextCardB>
                      </CardOne>

                      <CardOne

                      onPress={() =>this._onPress(1)}
                      style={{backgroundColor: (this.state.selectIndex == 1 ? "#242972" : "#FBFBFB")}}>
                      <TextNumber style={{color: (this.state.selectIndex == 1 ? "#FFF" : "#000")}}>{this.props.totalConcluidos}</TextNumber>
                          <TextCardB style={{color: (this.state.selectIndex == 1 ? "#FFF" : "#000")}}>Solicitações concluídas</TextCardB>
                      </CardOne>

                      <CardOne

                      onPress={() =>this._onPress(2)}
                      style={{backgroundColor: (this.state.selectIndex == 2 ? "#5359B1" : "#FBFBFB")}}>

                          <TextNumber style={{color: (this.state.selectIndex == 2 ? "#FFF" : "#000")}}>{this.props.totalAndamento}</TextNumber>
                          <TextCardB style={{color: (this.state.selectIndex == 2 ? "#FFF" : "#000")}}>Solicitações em andamento</TextCardB>
                      </CardOne>
                      ...
                      style={{backgroundColor: (this.state.selectIndex == 3 ? "#9DA1DE" : "#FBFBFB")}}>

                          <TextNumber style={{color: (this.state.selectIndex == 3 ? "#FFF" : "#000")}}>{this.props.totalSolicitacao - this.props.totalConcluidos}</TextNumber>
                          <TextCardB style={{color: (this.state.selectIndex == 3 ? "#FFF" : "#000")}}>Solicitações pendentes</TextCardB>
                      </CardOne>
                      </ContainerProps>
                  </CardMain>
                  <View>
                  ...
                  <ViewButton onPress={() => this.props.navigation.navigate('SolicitationConc')}>
                  <TextAll>Visualizar todas as solicitações concluidas</TextAll>
                  </ViewButton>
                    ...
                    {!! (this.state.selectIndex == 2 || this.state.selectIndex == 0) &&
                      ...
                      <ViewButton onPress={() => this.props.navigation.navigate('SolicitationAnd')}>
                      <TextAll>Visualizar todas as solicitações em andamento</TextAll>
                      </ViewButton>
                    </Card>
                    }
                    ...
                    </CardHeaderThree>
                    {
                            ...
                            this.props.solicitacoesConcluidas.map(function(value, index) {
                                ...
                                if((value.STATUS == 100 || value.STATUS == 101 || value.STATUS == 103 || value.STATUS == 104) && conta2 < 4)
                                {
                                    conta2++;
                                    return (
                                        <ViewButton onPress={() => self.props.navigation.navigate('PageID', {
                    ...
                    <ViewButton onPress={() => this.props.navigation.navigate('SolicitationPend')}>
                    <TextAll>Visualizar todas as solicitações pendentes</TextAll>
                    </ViewButton>
                    </Card>
                    }
...
function mapStateToProps(state) {
  ...
  export default connect( mapStateToProps, { getTotal, getSolicitacoesConcluidas,getSolicitacoesAndamento } )(Home);
