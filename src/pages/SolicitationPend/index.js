...
export class SolicitationPend extends Component {
    ...
    return (
      ...
      <ScrollView refreshControl={
          ...
          <Container>
              ...
              <ViewBG>
                <TextNumber>{this.props.totalSolicitacao - this.props.totalConcluidos}</TextNumber>
                <TextCard>Itens pendentes</TextCard>
                  ...
                  <CardMain>
                    {
                        ...
                        this.props.solicitacoesConcluidas.map(function(value, index) {
                            ...
                            if(value.STATUS == 100 || value.STATUS == 101 || value.STATUS == 103 || value.STATUS == 104)
                            {
                                count++;
...
function mapStateToProps(state) {
  ...
  export default connect( mapStateToProps, { getTotal, getSolicitacoesConcluidas,getSolicitacoesAndamento } )(SolicitationPend);
