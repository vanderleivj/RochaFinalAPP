  ...
  render() {
    return (
      <View>
        <ViewTop>
          <ContainerTop>
            <ButtonIcon onPress={() => this.props.navigation.navigate('Home')}>
            ...
            <ViewBG>
              ...
              <ContainerProps>
                <CardID>
                  ...
                  <TextHeader ellipsizeMode="tail" numberOfLines={1}>
                    {moment(
                      this.state.selectedItem != null
                ...
                <CardID>
                  ...
                  <TextHeader ellipsizeMode="tail" numberOfLines={1}>
                    {moment(
                      this.state.selectedItem != null
                        ? this.state.selectedItem.DATA_PREVISTA
                        : '',
                    ).format('DD/MM/YYYY')}
                  </TextHeader>
                </CardID>
              ...
              <CardMain>
                ...
                <Text>
                  {this.state.selectedItem != null
                    ? this.state.selectedItem.TITULO
                    : ''}
                </Text>
              </CardMain>
              ...
              <Card>
                {this.props.user.map(function(value, index) {
                  return (
                    <ViewButton
                      onPress={() =>
                        self.props.navigation.navigate('PersonPage', {
                          item: value,
                        })
                      }>
                      <ContainerCard>
                        <ImageBG>
                          <ID>{value.LOGIN.substring(0, 1)}</ID>
                        </ImageBG>
                        <ContainerCardMain>
                          <TextCardInside
                            ellipsizeMode="tail"
                          ...
                          <TextID>
                            {moment(value.DATA_INICIO).format('hh:mm')}
                          </TextID>
                        </ContainerCardMain>
                      </ContainerCard>
                      <Divider />
