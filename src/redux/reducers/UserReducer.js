    ...
    switch(action.type)
    {
        ...
        case GET_CALENDARIO:
                ...
                for(let i = 0; i < action.data.length; i++)
                {
                    ...
                    {
                        marked[action.data[i].DATA_PREVISTA.substring(0, 10)] = { marked: true, customStyles: {
                            container: {
                ...
                if(state.gerenteMarked != null)
                {
                    ...
                    Object.keys(rm).forEach(key => {marked[key] = rm[key];});
                ...
                if(state.gerenteAgenda != null)
                {
                    ...
                    Object.keys(rr).forEach(key => {agenda[key] = rr[key];});
