...
const getProcessosGarantiaEnd = (dispatch, data) => {
  dispatch({type: GET_PROCESSOS_GARANTIA_SP, data});
};
...
export const getProcessosGarantia = (obj, token, callback) => {
  return dispatch => {
    fetch('https://apps.blueprojects.com.br/rocha/Integration/Query', {
      method: 'POST',
      headers: {
      ...
      .then(responseJson => {
        ...
        if (responseJson.list != null) {
          getProcessosGarantiaEnd(dispatch, responseJson.list);
        }
